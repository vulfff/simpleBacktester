...
def ai_strategy_schema() -> Dict[str, Any]:
    ...
    return {
        ...
        "supported_providers": {
            "anthropic": {"name": "Anthropic Claude", "models": ["claude-opus-4-6", "claude-sonnet-4-6", "claude-3-5-sonnet-20241022", "claude-3-5-haiku-20241022"], "api_key_format": "sk-ant-...", "get_key_url": "https://console.anthropic.com/"},
            "openai": {"name": "OpenAI GPT", "models": ["gpt-4.1", "gpt-4.1-mini", "gpt-4o", "gpt-4o-mini", "o3", "o4-mini"], "api_key_format": "sk-...", "get_key_url": "https://platform.openai.com/api-keys"},
            "grok": {"name": "xAI Grok", "models": ["grok-3", "grok-3-mini", "grok-2"], "api_key_format": "xai-...", "get_key_url": "https://console.x.ai"},
            "gemini": {"name": "Google Gemini", "models": ["gemini-2.5-pro", "gemini-2.5-flash", "gemini-2.0-flash"], "api_key_format": "AIza...", "get_key_url": "https://aistudio.google.com/app/apikey"},
        },
